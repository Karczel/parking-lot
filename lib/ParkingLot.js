...
export class ParkingLot {
    constructor() {
        this.levels = []; // Initialize to an empty array
        this.fetch_levels().then(fetchedLevels => {
            this.levels = fetchedLevels; // Assign fetched levels
            console.log("Levels assigned:", this.levels); // Verify levels assignment
        });    }
